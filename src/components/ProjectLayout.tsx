import { ArrowLeft, ExternalLink, MoveLeft, MoveUpRight } from "lucide-react";
...
export default function ProjectLayout({
  ...
  return (
    <div className="bg-neutral-50 mt-4 flex flex-col gap-10 px-6 lg:px-24 py-12 rounded-2xl font-sans">
      <div className="flex flex-col gap-10 px-6 lg:px-24 py-12 w-full max-w-[1240px] mx-auto">
        {/* HEADER */}
        <div className="flex flex-col w-full gap-4 max-w-[700px] mx-auto">
          <div className="flex items-center gap-4 justify-between mb-6 group">
            ...
            <Link
              href="/"
              className="bg-neutral-900 text-neutral-100 w-fit px-4 py-2 rounded-md flex items-center gap-3"
            >
